...
public class Beratbadan extends Frame implements ActionListener{
    ...
    Beratbadan(){
        ...
        add(tf1);add(tf2);add(tf3);add(tf4);add(tf5);add(b1);add(l1);add(l2);add(l3);add(l4);add(l5);add(b2);
        setSize(400,400);
    ...
    public void actionPerformed(ActionEvent e) {  
        ...
        if(d>=18.5 && d<=24.9){
            tf5.setText("NIM: "+s4+ ",Nama: "+s3+" ,Berat anda sudah ideal");
        }else{
            tf5.setText("Berat anda tidak ideal");
        }}
